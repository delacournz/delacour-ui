...
import { IconAt, IconCurrencyDollar } from "@delacour/native-ui/icons/central";
 ...
 *
 * Every field here names its state once. Nothing repeats `isInvalid` on a
 * control, and no screen-level helper wraps a label around an input — that
 * duplication is what this component removed from five playground files.
 *
 * The keyboard handling is `Screen`'s, unchanged: `keyboardAware` lifts the
 * focused field clear of both the keyboard and the footer riding on it.
 */
				...
				<Field.Set>
					...
					<Field.Group>
						...
						<Field isInvalid={isUsernameTaken}>
							...
							<Input autoCapitalize="none" onChangeText={setUsername} value={username} />
				...
				<Field.Set>
					...
					<Field.Group>
						...
						<Field>
							...
							<Input multiline placeholder="Anything else we should know" size="lg" />
						</Field>
					</Field.Group>
				</Field.Set>
