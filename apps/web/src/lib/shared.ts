...
export const appDescription =
	"Accessible, composable React Native components with the defaults already decided. Own the source, and paint it from the same design tokens as your shadcn web app.";
