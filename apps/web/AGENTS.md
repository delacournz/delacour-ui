...
page and its install block, the Item page, the components index, the installation pages, the customiser, the 404, `/compare/heroui`, `/privacy` and the cookie banner, in both themes, at
