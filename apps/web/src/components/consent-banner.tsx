...
/**
 * Asks once whether Google Analytics may set its cookies.
 *
	...
	return (
		...
		>
			<p className="m-0 flex-1 text-fd-muted-foreground text-sm">
				Can Google Analytics set cookies to show us how the docs are used? Visits are counted without cookies either
				way.{" "}
