...
export const meta: DemoMeta = {
	...
	caption:
		"The default: a row, a chevron, and a panel that opens under it. It holds its own state, so nothing needs wiring — the panel's height is measured, then sprung from zero to whatever its content came out at.",
