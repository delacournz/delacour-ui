...
```bash
cd apps/mobile && bunx delacour@latest init     # into the app
cd packages/ui && bunx delacour@latest init     # into a shared package
```
...
```bash
bunx delacour@latest doctor --cwd apps/mobile
bunx delacour@latest doctor --cwd apps/tablet
```
