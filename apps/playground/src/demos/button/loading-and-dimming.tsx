...
export const meta: DemoMeta = {
	title: "Loading and dimming",
	caption: "Loading blocks the press but keeps full contrast. `isDimmedWhileLoading` fades it like `isDisabled`.",
};
...
export function Demo(): ReactElement {
	return (
		<View className="gap-3">
			<LoadingButton label="full contrast" spinnerPlacement="start" testID="full-contrast" variant="secondary" />
			<LoadingButton isDimmedWhileLoading label="dimmed" spinnerPlacement="start" testID="dimmed" variant="secondary" />
		</View>
	);
}
