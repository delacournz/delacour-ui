...
├── design-system/                the store, and the link out — see Customizer
...
**The reset button did not move into it.** `Reset to Vega / Neutral` is the undo of one tab's
decisions where the footer is the outcome of the whole screen, and an unconfirmed destructive action
should not sit permanently under the thumb beside the one people came for — least of all on the
Preview tab, where it would act on eight decisions you cannot see.
