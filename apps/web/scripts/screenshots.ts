...
const SHOTS: Shot[] = [
	...
	{ id: "32-docs-kpi-desktop-dark", path: "/docs/native/components/kpi", frame: "desktop", theme: "dark" },
	{ id: "33-docs-kpi-desktop-light", path: "/docs/native/components/kpi", frame: "desktop", theme: "light" },
	{
		id: "34-docs-kpi-full-mobile-dark",
	...
	{
		id: "35-docs-collapsible-desktop-dark",
		path: "/docs/native/components/collapsible",
		frame: "desktop",
		theme: "dark",
	},
	{
		id: "36-docs-collapsible-desktop-light",
		path: "/docs/native/components/collapsible",
		frame: "desktop",
		theme: "light",
	},
	{
		id: "37-docs-collapsible-mobile-dark",
		path: "/docs/native/components/collapsible",
		frame: "phone",
		theme: "dark",
	},
	{ id: "38-docs-skeleton-desktop-dark", path: "/docs/native/components/skeleton", frame: "desktop", theme: "dark" },
	{ id: "39-docs-skeleton-desktop-light", path: "/docs/native/components/skeleton", frame: "desktop", theme: "light" },
	{ id: "40-docs-skeleton-mobile-dark", path: "/docs/native/components/skeleton", frame: "phone", theme: "dark" },
